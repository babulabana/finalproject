...
//   const fileInputRef = useRef(); // <-- Ref for file inpu6t
//     useEffect(() => {
//         if (!user_id) {
//           navigate("/login");
//         }
...
// export default function AddBlog() {
//   const user_id = useSelector((state) => state.user.user_id); // ✅ Access user_id from Redux
//   const islogin = useSelector((state) => state.admin.islogin);
//   const isulogin = useSelector((state) => state.user.islogin);
