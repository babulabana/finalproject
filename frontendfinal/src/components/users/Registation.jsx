...
//         </button>
//         <div className='p-5'>
//           <p>Already have an account ?<span className='text-blue-500 px-3 font-semibold'><Link to="/userlogin">Login now</Link></span></p>
//         </div>
//       </form>
//     </div>
//   );
...
export default function Registration() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100  bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-4">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center">Registration</h2>
        ...
        <div className='p-5'>
          <p>
            ...
            <span className='text-blue-500 px-3 font-semibold'>
              <Link to="/userhome">Login now</Link>
            </span>
          </p>
        </div>
      </form>
